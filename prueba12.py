...
class PuntoEquilibrioApp:
    ...
    def create_widgets(self):
        ...
        tk.Label(self.root, text="REPRESENTAN LAS UNIDADES PARA ENCONTRAR EL PUNTO DE EQUILIBRIO").grid(row=3, column=0, columnspan=4)
        self.unidades_frame = tk.Frame(self.root)
        self.unidades_frame.grid(row=4, column=0, columnspan=4)

        # Crear entradas para la tabla de unidades
        ...
        # Segunda tabla para graficar resultados
        tk.Label(self.root, text="REPRESENTA LOS DATOS PARA CALCULAR LA GRAFICA DE PUNTO DE EQUILIBRIO").grid(row=9, column=0, columnspan=4)
        self.grafica_frame = tk.Frame(self.root)
        self.grafica_frame.grid(row=10, column=0, columnspan=4)

        # Crear entradas para la tabla de graficar
        ...
        self.result_frame.grid(row=12, column=0, columnspan=6)
